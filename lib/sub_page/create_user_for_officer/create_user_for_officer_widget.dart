                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium,
                        validator: _model.normalPhoneNumberControllerValidator
                            .asValidator(context),
                        inputFormatters: [
                          FilteringTextInputFormatter.allow(
                              RegExp('^[^\\s]*\$'))
                          ...
                          onPressed: () async {
                            ...
                            if ((_model.normalFullNameController.text != '') &&
                              ...
                              if ((_model.checkphonenumber?.succeeded ??
                                ...
                                shouldSetState = true;
                                if ((_model.checkreferral?.succeeded ?? true)) {
                                  _model.checkinvide =
                                      await UsersGroup.checkReferralCall.call(
                                    phoneNumber:
                                        _model.normalInviteController.text,
                                  ...
                                  shouldSetState = true;
                                  if ((_model.checkinvide?.succeeded ?? true)) {
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title: const Text('Invide ID Unregisted!'),
                                          content: const Text(
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: const Text('Referral ID Unregisted!'),
                                        content: const Text(
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: const Text('Phone number ready exist!'),
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if ((_model.normalFullNameController.text != '') &&
                            ...
                            shouldSetState = true;
                            if ((_model.checkphonenumber?.succeeded ?? true)) {
