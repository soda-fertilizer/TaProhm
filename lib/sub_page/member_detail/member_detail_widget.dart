                          ...
                          children: [
                            Container(
                              ...
                              child: CachedNetworkImage(
                                ...
                                imageUrl: memberDetailUsersRow!.profile,
                                fit: BoxFit.cover,
                              ),
                            ),
                            Padding(
                            ...
                            children: [
                                ...
                                builder: (context) =>
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          listViewCompaniesRowList.length,
                              ...
                              KeepAliveWidgetWrapper(
                                builder: (context) =>
                                  ...
                                  future:
                                      CompanyGroup.compayRatingByUserCall.call(
                                    id: memberDetailUsersRow.userID,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
