...
class ViewReviewWidget extends StatefulWidget {
  const ViewReviewWidget({
    super.key,
    required this.id,
  });
...
class _ViewReviewWidgetState extends State<ViewReviewWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewReviewModel());
                ...
                child: Column(
                  ...
                  children: [
                    RatingBarIndicator(
                      ...
                      rating: viewReviewCompaniesRatingRow!.rating!.toDouble(),
