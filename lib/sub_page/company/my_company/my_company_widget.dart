...
class _MyCompanyWidgetState extends State<MyCompanyWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyCompanyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<CompaniesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CompaniesRow> myCompanyCompaniesRowList = snapshot.data!;
                  ...
                  Expanded(
                    child: TabBarView(
                      ...
                      children: [
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          ...
                                          'name': serializeParam(
                                            myCompanyVarItem.companyName,
                                            ParamType.String,
                                          ),
                                          'phoneNumber': serializeParam(
                                            myCompanyVarItem.phoneNumber,
                                            ParamType.String,
                                          ),
                                          'link': serializeParam(
                                            myCompanyVarItem.telegramUrl,
                                            ParamType.String,
                                          ),
                                          'discount': serializeParam(
                                            myCompanyVarItem.discount,
                                            ParamType.double,
                                          ),
                                          'haveDocument': serializeParam(
                                            myCompanyVarItem.isVertify,
                                            ParamType.bool,
                                          ),
                                          'location': serializeParam(
                                            functions.returnLatLng(
                                                myCompanyVarItem.latitude,
                                                myCompanyVarItem.longitude),
                                            ParamType.LatLng,
                                          ),
                                          'images': serializeParam(
                                            myCompanyVarItem.companyImages,
                                            ParamType.String,
                                            true,
                                          ),
                                          'profile': serializeParam(
                                            myCompanyVarItem.companyProfile,
                                            ParamType.String,
                                          ),
                                          'detail': serializeParam(
                                            myCompanyVarItem.detail,
                                            ParamType.String,
                                          ),
                                          'userID': serializeParam(
                                            myCompanyVarItem.userID,
                                            ParamType.int,
                                          ),
                                        }.withoutNulls,
                                        extra: <String, dynamic>{
                        ...
                        Builder(
                          builder: (context) {
                            final myCompanyPending = myCompanyCompaniesRowList
                                .where((e) => e.isApprove == false)
                                .toList();
                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              scrollDirection: Axis.vertical,
                              itemCount: myCompanyPending.length,
                              itemBuilder: (context, myCompanyPendingIndex) {
                                final myCompanyPendingItem =
                                    myCompanyPending[myCompanyPendingIndex];
                                return Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 1.0),
                                  child: Container(
