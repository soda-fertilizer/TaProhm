...
class _AdminMainReferralWidgetState extends State<AdminMainReferralWidget> {
  late AdminMainReferralModel _model;
                ...
                child: Padding(
                  ...
                  child: FutureBuilder<List<SectorsRow>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<SectorsRow> listViewSectorsRowList = snapshot.data!;
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        scrollDirection: Axis.vertical,
                        itemCount: listViewSectorsRowList.length,
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context.pushNamed(
                                  'AdminUserReferral',
                                  queryParameters: {
                                    'sectorsID': serializeParam(
                                      listViewSectorsRow.sectorID,
                                      ParamType.int,
                                    ),
                                  }.withoutNulls,
                                );
