...
class _AdminCreateUserWidgetState extends State<AdminCreateUserWidget> {
  ...
  void initState() {
    ...
    _model.referrController ??= TextEditingController();
    _model.referrFocusNode ??= FocusNode();

    _model.telegramNumberController ??= TextEditingController();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    width: MediaQuery.sizeOf(context).width * 0.8,
                    child: TextFormField(
                      controller: _model.referrController,
                      focusNode: _model.referrFocusNode,
                      obscureText: false,
                      decoration: InputDecoration(
                        isDense: true,
                        labelText: 'Referral',
                      ...
                      validator:
                          _model.referrControllerValidator.asValidator(context),
                      inputFormatters: [
                ...
                FutureBuilder<List<SectorsRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<SectorsRow> dropDownSectorsRowList = snapshot.data!;
                    return FlutterFlowDropDown<String>(
                      controller: _model.dropDownValueController ??=
                          FormFieldController<String>(
                        _model.dropDownValue ??= dropDownSectorsRowList
                            .where((e) => e.sectorID == _model.selectSectorID)
                            .toList()
                            .first
                            .sectorName,
                      ),
                      ...
                      onChanged: (val) async {
                        ...
                        setState(() {
                          _model.selectSectorID = dropDownSectorsRowList
                              .where(
                                  (e) => e.sectorName == _model.dropDownValue)
                              .toList()
                              .first
                              .sectorID;
                        });
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if ((_model.fullNameController.text != null &&
                            ...
                            (_model.referrController.text != null &&
                                _model.referrController.text != '') &&
                            (_model.passwordController.text != null &&
                                _model.passwordController.text != '')) {
                          _model.createdUser = await UsersTable().insert({
                            'PhoneNumber': _model.telegramNumberController.text,
                            ...
                            'UserReferral': _model.referrController.text,
                          });
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                ...
                                content: Text('Please complete all the fild!'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
